...
namespace Darts_matches.Controllers
{
    public class DatabaseController
    {
        ...
        private void SetConnection()
        {
            ...
            string databaseLogPath = Environment.CurrentDirectory + "\\DatabaseMatchesLog.ldf";
        ...
        {
            // create database
            _connection = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;Integrated security=True;database=master");
        ...
        private void SetupDatabaseTables()
        {
            string createTableString =
                ...
                verage_per_3_darts_per_set_player1 TEXT NOT NULL,
